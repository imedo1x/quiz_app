...
class QuestionsSummary extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    // Limit the summary's height so it does not push the surrounding results
    // content and restart button off the screen.
    return SizedBox(
      height: 300,

      // Allow the user to scroll when all summary rows do not fit within the
      // fixed-height area.
      child: SingleChildScrollView(
        // The Column places every generated question-summary Row below the
